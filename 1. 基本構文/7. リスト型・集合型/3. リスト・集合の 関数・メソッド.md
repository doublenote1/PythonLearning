...
`list型.sort(key=None,reverse=False)`
...
> 2 つのオプション引数があり、
  `key` `reverse`はキーワード引数として指定されなければなりません
...
"昇順"
print(sorted(lst_al))  # ->  ['abc', 'bc', 'c']
print(sorted(lst_num))  # ->  [-1.5, -1, 0, 0.0, 1, 1.5, 3, 23, 123]
print(sorted(lst_snum))  # ->  ['-1', '-1.5', '0', '0.0', '1', '1.5', '123', '23', '3']
print(sorted(word))  # -> ['a', 'b', 'c']
try:
