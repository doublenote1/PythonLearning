...
"作業ディレクトリを取得"
print(os.getcwd())
# -> D:\Documents\Projects\Python Learning\1. 環境情報の取得

"実行ファイルの作業ディレクトリからの相対パスを取得"
print(__file__)
# -> D:/Documents/Projects/Python Learning/1. 環境情報の取得/4. 実行中のファイルのパスを取得する.py
...
target_path_1 = os.path.join(os.path.dirname(__file__), '4.1. reference.txt')
